<x-app-layout>
    <div class="max-w-2xl mx-auto px-3 pt-4">
        ...
        <h1 class="text-lg font-extrabold text-gray-900 dark:text-gray-100 mb-3">Pengaturan</h1>
        ...
        <div class="bg-white dark:bg-neutral-900 border border-gray-300 dark:border-neutral-800 rounded-lg p-3.5 mb-3">
            ...
            <form action="{{ route('settings.profile') }}" method="POST" class="space-y-3">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', auth()->user()->name) }}" required
                        class="w-full rounded-lg border-gray-300 dark:border-neutral-700 dark:bg-neutral-800 dark:text-gray-100 px-3 py-2.5 text-sm focus:ring-2 focus:ring-yellow-400">
